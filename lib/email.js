...
export const templates = {
  ...
  payoutReleased: ({ player, amount, net }) => ({
    ...
    html: shell(`Your payout is on the way`,
      `The sale of <b>${player}</b> (${amount}) is complete.<br/>Your payout of <b>${net}</b> (after the 10% fee) has been released from escrow. Arrival depends on your bank — typically 1–3 business days.`,
