...
export default function TradesPage() {
  ...
  return (
    <>
      ...
      <h1 className="page">Trade, don&apos;t just buy.</h1>
      <p className="sub">Swap slabs straight across, sweeten with cash, and see the fair-value delta before you commit.</p>
      ...
      {loading ? (
        ...
        <div className="trade-list">
          ...
          {list.map(proposal => {
            ...
            // For incoming: they offer → you receive; they request → you give
